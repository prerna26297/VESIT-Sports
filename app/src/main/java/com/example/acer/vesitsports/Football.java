...
public class Football extends AppCompatActivity {
    ...
    DatabaseReference rootRef,demoRef1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fixtures.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Football.this,fixturefoot.class);
        ...
        demoRef1 = rootRef.child("football");

        bye1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(Football.this);
                ...
                alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int which) {
                        ...
                        String value= classId + " BYE FOR FOOTBALL";
                        //push creates a unique id in database
                        demoRef1.push().setValue(value);
        ...
        register1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent2 = new Intent(Football.this,playfootball.class);
